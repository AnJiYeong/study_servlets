package com.ellie.study_servlets;
...
public class DatasInfor {
    ...
    public HashMap<String, Object> getBundlesData() {
        ...
        HashMap<String, Object> bundelsData = new HashMap<>();
        bundelsData.put("searchForm", searchForm);
        bundelsData.put("tablesListWithString", tablesListWithString);
        return bundelsData;
    }
}
